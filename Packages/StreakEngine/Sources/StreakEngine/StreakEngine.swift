/// Package version marker, pinned to the annotated release tag (streakengine-v1.1.0).
...
/// reboot sanity cap, slip archiving with windowed undo, and allowance adherence.
