...
| E5.1–E10.2 (rest) | ☐ not started | Per plan; no scope changes. Next: E5.1 (Session 16 — age gate; FIRST resolve the `age_gate_blocked` schema tension: not an MVP §5 row, enum closed + Architect-gated) |
