...
| E10.1–E10.2 (rest) | ☐ not started | Per plan. Next: Session 29 = the named StoreKit-config/contract session (scenario-29 diagnosis + event-spy sink + the live signed win-back purchase call); the goldens batch waits on the operator §3 copy pass |
