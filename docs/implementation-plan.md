...
| E9.1–E10.2 (rest) | ☐ not started | Per plan; no scope changes. Next: Session 27 = E9.1 safety layer (+E9.2 batchable) |

**Completion ratio (v1.0 scope, E0–E10 = 32 tasks):** 26 done + 1 half-scaffolded
(E0.3: harness shipped, device measurement operator-owned) = **81%** of build
tasks (delivery counter: 28/32 = 87.5% counting the half); milestones: M0 ✅,
