...
| E7.2–E10.2 (rest) | ☐ not started | Per plan; no scope changes. Next: Session 25 = E7.2 Superwall variant adapter (carrying the S24 deferrals by name), then E7.3 win-back |

**Completion ratio (v1.0 scope, E0–E10 = 32 tasks):** 24 done + 1 half-scaffolded
(E0.3: harness shipped, device measurement operator-owned) = **75%** of build
tasks (delivery counter: 26/32 = 81% counting the half); milestones: M0 ✅,
