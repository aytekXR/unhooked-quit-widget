...
Nothing below blocks the next session (Session 37 = UIR-4b (the settings-screen
restyle) + UIR-5 (motion/polish + the largest text-size axis) — the LAST agent-doable
UI-regeneration work, per YOUR regeneration mandate. Copy bytes stay untouched; no new
